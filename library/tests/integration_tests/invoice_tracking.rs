...
#[test_case(InMemory::new(); "in-memory")]
#[test_case(Sqlite::new(":memory:", "invoices", "output keys", "height").unwrap(); "sqlite")]
fn default_account_index<S>(store: S)
where
    S: Storage + 'static,
{
    // Setup.
...
#[test_case(InMemory::new(); "in-memory")]
#[test_case(Sqlite::new(":memory:", "invoices", "output keys", "height").unwrap(); "sqlite")]
fn zero_conf_invoice<S>(store: S)
where
    S: Storage + 'static,
{
    // Setup.
...
#[test_case(InMemory::new(); "in-memory")]
#[test_case(Sqlite::new(":memory:", "invoices", "output keys", "height").unwrap(); "sqlite")]
fn timelock_rejection<S>(store: S)
where
    S: Storage + 'static,
{
    // Setup.
...
#[test_case(InMemory::new(); "in-memory")]
#[test_case(Sqlite::new(":memory:", "invoices", "output keys", "height").unwrap(); "sqlite")]
fn track_parallel_invoices<S>(store: S)
where
    S: Storage + 'static,
{
    // Setup.
...
#[test_case(InMemory::new(); "in-memory")]
#[test_case(Sqlite::new(":memory:", "invoices", "output keys", "height").unwrap(); "sqlite")]
fn set_initial_height<S>(store: S)
where
    S: Storage + 'static,
{
    // Setup.
